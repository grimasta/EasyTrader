...
from grok_produce.structured.indicators import calculate_rsi, calculate_bollinger_bands, calculate_volume_ma, calculate_ema, calculate_stochastic_rsi
...
class StochasticStrategy(Strategy):
    ...
    def check_4h_confluence(self, df_4h, current_time):
        ...
        price = latest_4h['close']
        bb_lower = latest_4h['bb_lower']
        return abs(price - bb_lower) / price < 0.02  # No EMA condition
