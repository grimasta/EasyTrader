from venues.structured.indicators import calculate_rsi, calculate_bollinger_bands, calculate_volume_ma, \
    calculate_ema
from technical_indicators import stochastic_rsi
...
def apply_indicators(df, timeframe='5m'):
    ...
    """
    df = df.copy()
    df['rsi'] = stochastic_rsi(df, window=14)
