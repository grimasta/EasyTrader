...
from venues.bitget_v2.api_client.background_order_tpsl_coordinator import place_limit_long, handle_sl_if_any, \
    audit_and_fix_brackets, recover_open_positions_and_watch
from venues.bitget_v2.api_client.entry_guard import is_blocked as guard_blocked
from venues.bitget_v2.api_client.v2_get_account_balance import get_account_balance, get_account_current
from core.Runtimes.Live.live_constants import STRATEGY_NAME, WATCH_TIMEFRAME, SYMBOLS, PROFIT_TARGET, \
...
# )
# from venues.bitget_v2.api_client import is_blocked as guard_blocked
from venues.bitget_v2.api_client.v2_on_candle_close_tp_sl import has_active_bracket

# Live candles (global manager)
from venues.bitget_v2.websocket.bitget_live_klines import (
...
def live_trading(strategy_name=STRATEGY_NAME):
    ...
    # 4) Runtimes state (persist/restore hooks if you want)
    ...
    try:
        ...
        logging.info("Runtimes state rebuilt from disk/cache.")
    except Exception:
